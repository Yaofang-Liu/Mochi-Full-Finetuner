...
from genmo.mochi_preview.dit_pusa.joint_model.layers import (
    FeedForward,
    PatchEmbed,
    RMSNorm,
    TimestepEmbedder,
)
from genmo.mochi_preview.dit_pusa.joint_model.mod_rmsnorm import modulated_rmsnorm
from genmo.mochi_preview.dit_pusa.joint_model.residual_tanh_gated_rmsnorm import (
    residual_tanh_gated_rmsnorm,
)
from genmo.mochi_preview.dit_pusa.joint_model.rope_mixed import (
    compute_mixed_rotation,
    create_position_matrix,
)
from genmo.mochi_preview.dit_pusa.joint_model.temporal_rope import apply_rotary_emb_qk_real
from genmo.mochi_preview.dit_pusa.joint_model.utils import (
    AttentionPool,
    modulate,
    pad_and_split_xy,
    unify_streams,
...
class AsymmetricJointBlock(nn.Module):
    ...
    def forward(
        ...
        **attn_kwargs,
        ...
        if self.update_y:
            scale_msa_y, gate_msa_y, scale_mlp_y, gate_mlp_y = mod_y.chunk(4, dim=2) 
        else:
            scale_msa_y = mod_y
